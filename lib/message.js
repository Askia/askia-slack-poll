...
import {callbackId, last, sorter} from "./util.js";
 ...
 * @type {SlackMessage}
 */
export const createSlackMessage = poll => ({
...
const createSlackAttachment = (poll, response) => ({
  ...
  "actions": [createSlackButton(response)]
});
 ...
 */
const createSlackButton = response => {
